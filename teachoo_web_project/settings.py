...
DATABASES = {
    'default': {
        ...
        'NAME': 'gg',                      # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'teachoo_web_project.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'teachoo_web_project.wsgi.application'
...
AUTHENTICATION_BACKENDS = (# Needed to login by username in Django adminm regardless of 'allauth'
